...
class _HomePageState extends State<HomePage> {
  Widget _buildCategoryProduct({String image, num color}) {
    return CircleAvatar(
  ...
  Widget _buildImageSlider() {
    return Container(
      ...
      child: Carousel(
        ...
        showIndicator: false,
        images: [
          AssetImage("images/bg1.png"),
          AssetImage("images/bg2.png"),
          AssetImage("images/bg3.png"),
        ],
      ),
    );
  }
  ...
  Widget _buildDressIcon() {
    ...
    List<Product> drama = categoryProvider.getDressList;
    return Row(
      ...
      return GestureDetector(
        ...
        child: _buildCategoryProduct(image: e.image, color: 0xffb30000),
      );
    }).toList());
  }

  Widget _buildShirtIcon() {
    List<Product> history = categoryProvider.getShirtList;
  ...
  Widget _buildShoeIcon() {
    ...
    List<Product> mystery = categoryProvider.getshoesList;
    return Row(
  ...
  Widget _buildPantIcon() {
    ...
    List<Product> romance = categoryProvider.getPantList;
    return Row(
  ...
  Widget _buildTieIcon() {
    ...
    List<Product> scifi = categoryProvider.getTieList;
    return Row(
  ...
  Widget _buildFeature() {
    ...
    homefeature = productProvider.getFeatureList;
  ...
  Widget _buildNewAchives() {
    List<Product> homeachive = productProvider.getNewAchiesList;
    return Column(
      children: <Widget>[
        Container(
          height: height * 0.1 - 30,
