...
class ProductProvider with ChangeNotifier {
  ...
  Future<void> getFeatureData() async {
    ...
    QuerySnapshot featureSnapShot = await FirebaseFirestore.instance
        .collection("products")
        .doc(
            "ujUAGXmcQAE8ilwAnS7C") /* code here is good na; not sure sa iba :< */
        .collection("featureproduct") /* changed na */
        .get();
  ...
  Future<void> getHomeAchiveData() async {
    List<Product> newList = [];
    QuerySnapshot homeachiveSnapShot = await FirebaseFirestore.instance
  ...
  Future<void> getNewAchiveData() async {
    ...
    QuerySnapshot newachivesSnapShot = await FirebaseFirestore.instance
        .collection("products")
        .doc("ujUAGXmcQAE8ilwAnS7C")
        .collection("newachives") /* goods na code here */
        .get();
